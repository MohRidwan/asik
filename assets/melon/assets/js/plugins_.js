		...
		if ($.fn.dataTable) {
			...
			$.extend(true, $.fn.dataTable.defaults, {				
				...
				drawCallback: function () {
					...
					search_input.parent().prepend('<span class="input-group-addon"><i class="fa fa-search" aria-hidden="true"></i></span>');
			...
			$.fn.dataTable.defaults.lengthMenu = [[5, 10, 25, 50, 100, 500, 1000, -1], [5, 10, 25, 50, 100, 500, 1000, "All"]];
			...
			$('.datatable').each(function () {
				...
				if (typeof data_horizontalWidth != 'undefined') {
					$.extend(true, options, {
						"scrollX": "100%",
						"scrollXInner": data_horizontalWidth,
						"scrollCollapse": true
					});
				}
				...
				if (self.hasClass('table-tabletools')) {
					$.extend(true, options, {
						"dom": "<'row'<'dataTables_header clearfix'<'col-md-4'l><'col-md-8'Tf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", // T is new
						"oTableTools": {
							"aButtons": [
								"copy",
								"print",
				...
				if (self.hasClass('table-colvis')) {
					$.extend(true, options, {
						"dom": "<'row'<'dataTables_header clearfix'<'col-md-6'l><'col-md-6'Cf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", // C is new
						"oColVis": {
							"buttonText": "Columns <i class='fa fa-angle-down' aria-hidden='true'></i>",
							"iOverlayFade": 0
						}
					});
				}
				...
				if (self.hasClass('table-responsive')) {
					...
					var old_fnDrawCallback = $.fn.dataTable.defaults.drawCallback;
