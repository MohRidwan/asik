...
<title>Untitled Document</title>
    ...
    <!--<link rel="stylesheet" href="assets/css/customboot.min.css">-->
  	<link rel="stylesheet" href="assets/css/customboot.css">	
...
<body>
        ...
        <!--<div class="atas">-->
        <!-- Logo -->
			<!--<span class="logo-header logo-text" href="#">
				<img src="/img/KPlogo.png" width="75" height="75">
       ...
       <!-- </div>-->
            ...
            <div class="col-md-2"> 
            <div class="icon-bar">
              <a class="active" href="#"><i class="fa fa-home"><span></span></i></a>
